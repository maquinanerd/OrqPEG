...
rem ---------------------------------------------------------------------------
rem  OrqPEG - situacao atual de cada projeto: estado da execucao, progresso dos
rem  prompts, branch, PR, CI, consenso, gates e ultimo erro.
rem  Uso opcional: STATUS.cmd meu-projeto
rem  Comando: node dist\cli\main.js status
rem ---------------------------------------------------------------------------
...
node "%~dp0dist\cli\main.js" status %*
