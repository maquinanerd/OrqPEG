...
(function () {
  ...
  var LOOP_TRIGGER_LABEL = {
    ...
    SKILL_CHANGED_DURING_RUN: 'Uma Skill foi editada durante a execução',
    PROJECT_CONTEXT_CHANGED: 'O contexto do projeto mudou durante a execução',
    PROJECT_CONFIG_CHANGED: 'O cadastro do projeto foi alterado durante a execução',
    POLICY_SNAPSHOT_MISSING: 'Execução sem política congelada',
    ...
    CI_REPAIR_BUDGET_EXHAUSTED: 'Ciclos de reparo de CI esgotados',
    CI_CONFIGURATION_ERROR: 'Erro na configuração do CI',
    CI_REQUIRED_CHECK_MISSING: 'Check obrigatório ausente no CI',
