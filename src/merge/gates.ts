...
export const GATE_DEFINITIONS: ReadonlyArray<GateDefinition> = [
  ...
  { id: 'PR_OPEN', index: 4, title: 'A PR está aberta' },
  { id: 'PR_BASE_CORRECT', index: 5, title: 'A base da PR está correta' },
  ...
  { id: 'LOCAL_TESTS_PASSED', index: 7, title: 'Testes locais passaram' },
  {
    ...
    index: 8,
    title: 'Todos os checks obrigatórios passaram',
  },
  {
    id: 'NO_PENDING_REQUIRED_CHECKS',
    index: 9,
    title: 'Nenhum check obrigatório está pendente',
  },
  {
    id: 'NO_SKIPPED_REQUIRED_CHECKS',
    index: 10,
    title: 'Nenhum check obrigatório foi ignorado',
  },
  { id: 'NO_UNRESOLVED_THREADS', index: 11, title: 'Não existem threads não resolvidas' },
  {
    id: 'NO_HUMAN_CHANGES_REQUESTED',
    index: 12,
    title: 'Não existe revisão humana solicitando mudanças',
  },
